...
const BeautyAndHygiene = () => {
  ...
  const BASE_URL = import.meta.env.VITE_BACKEND_URL || 'https://my-projects-5.onrender.com/';
    ...
    useEffect(() => {
      dispatch(fetchdata('Beauty & Hygiene'))
    }, [dispatch])
  ...
  return (<Box bg='lavender'pb='100px' >
    <Box w="72%" ml="14%" mt="20px" pt='20px'>
      <Image borderRadius='10px' src='https://www.bigbasket.com/media/uploads/banner_images/b2c081912730-24802_b2c_hp_bbh_cm_dove_460_010924_all.jpg?tr=w-1920,q=80'/>
    <Text  pt='20px'>Beauty & Hygiene</Text>
