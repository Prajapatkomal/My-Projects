...
const CleaningAndHousehold = () => {
  ...
  const BASE_URL = import.meta.env.VITE_BACKEND_URL || 'https://my-projects-5.onrender.com/';
    ...
    useEffect(() => {
      dispatch(fetchdata('Cleaning & Household'))
    }, [dispatch])
  ...
  return (<Box bg='lavender' pb='100px'>
    ...
    <Image borderRadius='10px' src='https://www.bigbasket.com/media/uploads/banner_images/b2c081912730-24799_b2c_hp_dnc_cm_surf-excel_460_010924_all.jpg?tr=w-1920,q=80'/>
    <Text  pt='20px'>Cleaning & Household</Text>
