import { Button, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, Flex, Heading, Input, Spacer, Text, useDisclosure } from '@chakra-ui/react'
...
import navStyle from './Navbar.module.css'
   ...
   export  function SignDrawer() {
        ...
        return (
          <>
            <Button ref={btnRef} bg='white' onClick={onOpen} fontSize={'22px'}>
            ...
            >
              ...
              <DrawerContent>
                <DrawerCloseButton />
                <DrawerHeader pb='50'>Sign In</DrawerHeader>
      
                <DrawerBody>
                  < Flex direction={'column'}  gap='2'>
                  <Heading size='md'>Email</Heading>
                  <Input placeholder='Type Email here...' /> <br/>
                  <Heading size='md'>Password</Heading>
                  <Input placeholder='Type Password here...' />
                  <Text pl='150'><Link className={navStyle.Link}>Forgot Password</Link></Text>
                  </Flex>
                </DrawerBody>
