...
const ShoppingBag = () => {
  ...
  <PopoverTrigger>
   ...
   Shopping Bag-  <Text color='blue' fontSize={'25px'}>{cart}</Text> </Button>
  </PopoverTrigger>
  <PopoverContent>
    <PopoverArrow/>
    <PopoverCloseButton/>
    <PopoverHeader>  <Link>Shopping Bag</Link></PopoverHeader>
    <PopoverBody>Order Value: {cart} <br/>
    </PopoverBody>
  </PopoverContent>
</Popover>
    )
