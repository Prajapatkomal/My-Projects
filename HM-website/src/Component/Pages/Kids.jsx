...
import {  Box, Button, Center, Flex, Grid, GridItem, Image, Select, Text } from '@chakra-ui/react'
...
const Kids = () => {
  ...
  useEffect(() => {
    dispatch(fetchdata('Kids Products'))
  }, [dispatch])
  ...
  return (<>
   <Select border='3px solid' ml='50px' w='200px' placeholder='select type' onChange={(e)=>setSearchTerm(e.target.value)}>
             <option  color='white' value='toy'>toy</option>
             <option value='Dress'>Dress</option>
             <option value='pants'>pants</option>
      </Select>


     <Image ml='30%' p='50px' boxSize={'400px'}  w='600px' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoakqes0SQXKWGMX51itbO4L5SmfmIP_P0yg&s'/>
